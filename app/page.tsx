              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  <DialogTrigger asChild>
                    <button className="text-sm sm:text-base text-gray-600 hover:text-blue-600 transition-colors">
                      Contact
                    </button>
                  </DialogTrigger>
                </Dialog>
                ...
                <DropdownMenu open={isMenuOpen} onOpenChange={setIsMenuOpen}>
                  ...
                  <DropdownMenuContent align="end" className="w-48">
                    ...
                    <DropdownMenuItem asChild>
                      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        <DialogTrigger asChild>
                          <button className="w-full text-left cursor-pointer">Contact</button>
                        </DialogTrigger>
                      </Dialog>
                    </DropdownMenuItem>
                  </DropdownMenuContent>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 max-w-3xl mx-auto px-4">
            A unified platform that streamlines school administration, enhances parent-teacher communication, and
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
              From attendance tracking to coding education, we provide comprehensive tools for modern education
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Advanced attendance system with real-time tracking and alerts</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Interactive drag-and-drop coding platform for students to learn programming visually
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Collaborative platform where students connect, ask questions, and teachers provide guidance
                </CardDescription>
              </CardHeader>
            </Card>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Automate routine tasks and focus on what matters most - education</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Access everything from anywhere with our responsive mobile platform</p>
            </div>
      ...
      <section className="py-16 sm:py-20 px-4 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-blue-100 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
            Join hundreds of schools already using Global School Portal to streamline operations and enhance education
          </p>
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>What happens next?</strong> Our team will review your request and contact you within 24 hours
